...
Suspect::Suspect(const std::string& name, SpriteData& spriteData, const int& sprIndex, std::vector<std::string> motives)
	: Card(name, spriteData, sprIndex), motives(motives)
{
